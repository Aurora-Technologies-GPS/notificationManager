...
<div class="dropdown">
  <button class="btn content-select dropdown-toggle" :style="{ borderColor:' #829aa8' }" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{'Unclassified'}}</button>

  <div class="dropdown-menu paletaColores" aria-labelledby="dropdownMenuButton">

<div @click="setColor('66CC00',0)" class="color" style="border-radius: 25px 25px 0px 0px; background:#66CC00;"> 
</div>
<div @click="setColor('66CC66',0, 'Unclassified')" class="color" style="background:#66CC66;"></div>
<div @click="setColor('66CCCC',0, 'Unclassified')" class="color" style="background:#66CCCC;"></div>
<div @click="setColor('66CCFF',0, 'Unclassified')" class="color" style="background:#66CCFF;"></div>
<div @click="setColor('669900',0, 'Unclassified')" class="color" style="background:#669900;"> 
</div>
<div @click="setColor('669966',0,'Unclassified')" class="color" style="background:#669966;"> 
</div>
<div @click="setColor('6699CC',0,'Unclassified')" class="color" style="background:#6699CC;"> 
</div>
<div @click="setColor('6699FF',0,'Unclassified')" class="color" style="background:#6699FF;"> 
</div>

<div @click="setColor('FF0000',0,'Unclassified')" class="color" style="background:#FF0000;"> 
</div>

<div @click="setColor('FF0066',0,'Unclassified')" class="color" style="background:#FF0066;"> 
</div>
<div @click="setColor('FF00CC',0,'Unclassified')" class="color" style="background:#FF00CC;"> 
</div>
<div @click="setColor('FF00FF',0,'Unclassified')" class="color" style="background:#FF00FF;"> 
</div>
<div @click="setColor('FF66CC',0,'Unclassified')" class="color" style="background:#FF66CC; "> 
</div>
<div @click="setColor('FF66FF',0,'Unclassified')" class="color" style="background:#FF66FF;"> 
</div>
<div @click="setColor('FF9999',0,'Unclassified')" class="color" style="background:#FF9999; "> 
</div>
  
<div @click="setColor('FF99CC',0,'Unclassified')" class="color" style="background:#FF99CC; "> 
</div>
<div @click="setColor('FF99FF',0,'Unclassified')" class="color" style="background:#FF99FF; "> 
</div>
<div @click="setColor('FF9966',0,'Unclassified')" class="color" style="background:#FF9966; "> 
</div>
<div @click="setColor('FF9933',0,'Unclassified')" class="color" style="background:#FF9933; "> 
</div>
<div @click="setColor('FF9900',0,'Unclassified')" class="color" style="background:#FF9900; "> 
</div>
<div @click="setColor('FF9933',0,'Unclassified')" class="color" style="background:#FF9933;"> 
</div>

<div @click="setColor('9fa3a9',0,'Unclassified')" class="color" style="background:#9fa3a9;"> 
</div>
<div @click="setColor('6a6e73',0,'Unclassified')" class="color" style="background:#6a6e73;"> 
</div>
<div @click="setColor('393d42',0,'Unclassified')" class="color" style="background:#393d42;"> 
</div>
<div @click="setColor('1f2124',0,'Unclassified')" class="color" style="background:#1f2124;"> 
</div>
<div @click="setColor('171718',0,'Unclassified')" class="color" style="border-radius: 0px 0px 25px 25px; background:#171718;"> 
</div>
